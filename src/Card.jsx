...
export default function Card({ thumbnail, price, onAddToCart }) {
  ...
  return (
    <div class="relative m-10 w-full max-w-xs overflow-hidden rounded-lg bg-white shadow-md">
      ...
      <div class="mt-4 px-5 pb-5">
          <h5 class="text-xl font-semibold tracking-tight text-slate-900">{thumbnail}</h5>
        ...
        <div class="flex items-center justify-between">
          ...
          <a href="#" class="flex items-center rounded-md bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300" onClick={onAddToCart}>
